...
{
	ros::init(argc, argv, "snake_node1_sub");

	ros::NodeHandle nh;

	ros::Subscriber sub = nh.subscribe("snake_joint_angle", 100, Callback);

	pub1 = new ros::Publisher(nh.advertise<std_msgs::Float64>("/snake/joint1_position_controller/command", 100));
	pub2 = new ros::Publisher(nh.advertise<std_msgs::Float64>("/snake/joint2_position_controller/command", 100));
	pub3 = new ros::Publisher(nh.advertise<std_msgs::Float64>("/snake/joint3_position_controller/command", 100));
	pub4 = new ros::Publisher(nh.advertise<std_msgs::Float64>("/snake/joint4_position_controller/command", 100));
	pub5 = new ros::Publisher(nh.advertise<std_msgs::Float64>("/snake/joint5_position_controller/command", 100));
	pub6 = new ros::Publisher(nh.advertise<std_msgs::Float64>("/snake/joint6_position_controller/command", 100));
	pub7 = new ros::Publisher(nh.advertise<std_msgs::Float64>("/snake/joint7_position_controller/command", 100));
	pub8 = new ros::Publisher(nh.advertise<std_msgs::Float64>("/snake/joint8_position_controller/command", 100));
	pub9 = new ros::Publisher(nh.advertise<std_msgs::Float64>("/snake/joint9_position_controller/command", 100));
	pub10 = new ros::Publisher(nh.advertise<std_msgs::Float64>("/snake/joint10_position_controller/command", 100));
	pub11 = new ros::Publisher(nh.advertise<std_msgs::Float64>("/snake/joint11_position_controller/command", 100));
	pub12 = new ros::Publisher(nh.advertise<std_msgs::Float64>("/snake/joint12_position_controller/command", 100));
	pub13 = new ros::Publisher(nh.advertise<std_msgs::Float64>("/snake/joint13_position_controller/command", 100));
	pub14 = new ros::Publisher(nh.advertise<std_msgs::Float64>("/snake/joint14_position_controller/command", 100));
	pub15 = new ros::Publisher(nh.advertise<std_msgs::Float64>("/snake/joint15_position_controller/command", 100));
	pub16 = new ros::Publisher(nh.advertise<std_msgs::Float64>("/snake/joint16_position_controller/command", 100));
	pub17 = new ros::Publisher(nh.advertise<std_msgs::Float64>("/snake/joint17_position_controller/command", 100));
	pub18 = new ros::Publisher(nh.advertise<std_msgs::Float64>("/snake/joint18_position_controller/command", 100));
	pub19 = new ros::Publisher(nh.advertise<std_msgs::Float64>("/snake/joint19_position_controller/command", 100));
	pub20 = new ros::Publisher(nh.advertise<std_msgs::Float64>("/snake/joint20_position_controller/command", 100));
