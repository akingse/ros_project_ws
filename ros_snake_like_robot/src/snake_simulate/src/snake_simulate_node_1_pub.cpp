...
{
	ros::init(argc, argv, "snake_simulate_node_1_pub");
	ros::NodeHandle nh;
	ros::Publisher pub1 = nh.advertise<std_msgs::Float64>("/snake_simulate/joint1_position_controller/command", 100);
	ros::Publisher pub2 = nh.advertise<std_msgs::Float64>("/snake_simulate/joint2_position_controller/command", 100);
	ros::Publisher pub3 = nh.advertise<std_msgs::Float64>("/snake_simulate/joint3_position_controller/command", 100);
	ros::Publisher pub4 = nh.advertise<std_msgs::Float64>("/snake_simulate/joint4_position_controller/command", 100);
	ros::Publisher pub5 = nh.advertise<std_msgs::Float64>("/snake_simulate/joint5_position_controller/command", 100);
	ros::Publisher pub6 = nh.advertise<std_msgs::Float64>("/snake_simulate/joint6_position_controller/command", 100);
	ros::Publisher pub7 = nh.advertise<std_msgs::Float64>("/snake_simulate/joint7_position_controller/command", 100);
	ros::Publisher pub8 = nh.advertise<std_msgs::Float64>("/snake_simulate/joint8_position_controller/command", 100);
	ros::Publisher pub9 = nh.advertise<std_msgs::Float64>("/snake_simulate/joint9_position_controller/command", 100);
	ros::Publisher pub10 = nh.advertise<std_msgs::Float64>("/snake_simulate/joint10_position_controller/command", 100);
	ros::Publisher pub11 = nh.advertise<std_msgs::Float64>("/snake_simulate/joint11_position_controller/command", 100);
	ros::Publisher pub12 = nh.advertise<std_msgs::Float64>("/snake_simulate/joint12_position_controller/command", 100);
	ros::Publisher pub13 = nh.advertise<std_msgs::Float64>("/snake_simulate/joint13_position_controller/command", 100);
	ros::Publisher pub14 = nh.advertise<std_msgs::Float64>("/snake_simulate/joint14_position_controller/command", 100);
	ros::Publisher pub15 = nh.advertise<std_msgs::Float64>("/snake_simulate/joint15_position_controller/command", 100);
	ros::Publisher pub16 = nh.advertise<std_msgs::Float64>("/snake_simulate/joint16_position_controller/command", 100);
	ros::Publisher pub17 = nh.advertise<std_msgs::Float64>("/snake_simulate/joint17_position_controller/command", 100);
	ros::Publisher pub18 = nh.advertise<std_msgs::Float64>("/snake_simulate/joint18_position_controller/command", 100);
	ros::Publisher pub19 = nh.advertise<std_msgs::Float64>("/snake_simulate/joint19_position_controller/command", 100);
	ros::Publisher pub20 = nh.advertise<std_msgs::Float64>("/snake_simulate/joint20_position_controller/command", 100);
	...
	double omega_yaw = Pi/2;
	double omega_pitch = Pi/2;
